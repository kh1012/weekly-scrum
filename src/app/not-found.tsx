  ...
  return (
    <div className="min-h-screen bg-[#f6f8fa] flex flex-col items-center justify-center px-4">
      <div className="max-w-2xl w-full">
        ...
        {/* 메인 카드 */}
        <div className="bg-white rounded-xl shadow-sm border border-[#d0d7de] p-8 sm:p-12">
          {/* 404 아이콘 */}
          <div className="flex justify-center mb-6">
            <svg
              className="w-24 h-24 text-[#57606a]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          {/* 타이틀 */}
          <h1 className="text-3xl font-bold text-[#24292f] text-center mb-3">
            404 - 페이지를 찾을 수 없습니다
          </h1>

          {/* 설명 */}
          <p className="text-[#57606a] text-center mb-8">
            요청하신 페이지가 존재하지 않거나 이동되었습니다.
          </p>

          {/* 라우팅 개편 안내 */}
          <div className="bg-[#ddf4ff] border border-[#54aeff] rounded-lg p-4 mb-8">
            <div className="flex gap-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-[#0969da] mb-1">
                  라우팅 구조가 개편되었습니다
                </h3>
                <p className="text-sm text-[#0969da]">
                  더 나은 사용자 경험을 위해 메뉴 구조를 정리했습니다. 모든
                  Works 관련 페이지는 이제 <code className="px-1.5 py-0.5 bg-white rounded text-xs font-mono">/works</code> 경로 하위로
                  이동되었습니다.
                </p>
              </div>
            </div>
          ...
          <div className="flex justify-center mb-8">
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#24292f] text-white font-semibold rounded-lg hover:bg-[#32383f] transition-colors shadow-sm"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
          ...
          <div className="border-t border-[#d0d7de] pt-8 mt-8">
            <h3 className="text-sm font-semibold text-[#24292f] mb-4 text-center">
              주요 메뉴 바로가기
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Link
                ...
                className="flex items-center gap-3 p-3 rounded-lg border border-[#d0d7de] hover:bg-[#f6f8fa] hover:border-[#57606a] transition-all group"
              >
                <svg
                  className="w-5 h-5 text-[#57606a] group-hover:text-[#24292f]"
                  fill="currentColor"
                  viewBox="0 0 640 512"
                >
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium text-[#24292f] group-hover:text-[#0969da]">
                    Team Feed
                  </div>
                  <div className="text-xs text-[#57606a]">팀 활동 피드</div>
                </div>
              </Link>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-[#57606a]">계획 간트 차트</div>
                </div>
              </Link>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-[#57606a]">스냅샷 뷰어</div>
                </div>
              </Link>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-[#57606a]">업무 맵</div>
                </div>
              </Link>
            </div>
