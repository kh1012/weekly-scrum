        ...
        <div className="space-y-3 mb-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <StatCard
                label="지난 주 작성 완료"
                value={`${stats.completedLastWeek}/${stats.totalMembers}`}
                highlight={stats.completedLastWeek === stats.totalMembers}
              />
            </div>
          </div>
                    ...
                    {recentWeeks.map((w, idx) => (
                      <th
                        ...
                        className={`px-3 py-2 text-center text-xs font-semibold border-r border-[#d0d7de] ${
                          idx === 1 ? "text-[#0969da] bg-[#ddf4ff]" : "text-[#57606a]"
                        }`}
                      >
                        <div>{w.label}</div>
                  ...
                  {memberDataList.map((member) => (
                    ...
                    >
                      ...
                      {recentWeeks.map((w, idx) => {
                        ...
                        const isLastWeek = idx === 1; // 지난 주를 하이라이트
