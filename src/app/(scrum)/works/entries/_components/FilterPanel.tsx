...
export function FilterPanel({
  ...
  const handleApply = () => {
    onApplyFilters({
      ...
      cursor: undefined, // 필터 변경 시 페이지네이션 리셋
    });
  };
  ...
  return (
    <>
      ...
      {/* Filter panel */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white border-r border-[#d0d7de] overflow-y-auto transition-transform lg:translate-x-0 ${
