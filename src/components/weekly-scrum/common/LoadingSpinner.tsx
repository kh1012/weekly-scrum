  ...
  return (
    ...
    >
      <style>{`
        ...
        .logo-rotate-ring {
          animation: logo-rotate-ring 10s linear infinite;
        }
        .logo-fade {
      ...
      <div className="relative w-24 h-24 flex items-center justify-center">
        {/* Rotating ring */}
        <div className="absolute inset-0 logo-rotate-ring">
          <div
            className="w-full h-full rounded-full border-2 border-dashed logo-fade"
            style={{ borderColor: "#F76D57" }}
          />
        </div>
        {/* Pulsing logo */}
        <svg
          className="w-16 h-16 logo-pulse relative z-10"
          viewBox="0 0 640 640"
          fill="currentColor"
          style={{ color: "#F76D57" }}
          aria-hidden="true"
