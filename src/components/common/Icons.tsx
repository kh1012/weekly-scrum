...
// 나뭇잎 (여유) - FontAwesome fa-leaf style
export const LeafIcon = memo(function LeafIcon({
  size = 16,
  className = "",
  ...props
}: IconProps) {
...
// 볼트 (적정) - FontAwesome fa-bolt style
...
// 불꽃 (부담) - FontAwesome fa-fire style
export const FireIcon = memo(function FireIcon({
  size = 16,
  className = "",
  ...props
}: IconProps) {
