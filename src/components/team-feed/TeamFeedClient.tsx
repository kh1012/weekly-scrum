...
export function TeamFeedClient({
  ...
  const handleApplyFilters = useCallback(
    (newGnbParams: GnbParams) => {
      ...
      if (newGnbParams.dateRangeStart)
        params.set("dateRangeStart", newGnbParams.dateRangeStart);
      if (newGnbParams.dateRangeEnd)
        params.set("dateRangeEnd", newGnbParams.dateRangeEnd);
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] bg-white">
      ...
      <div className="flex-1 flex flex-col lg:flex-row min-w-0">
        {/* Center: Entries List */}
        <div className="flex-1 min-w-0 px-4 py-6 h-[calc(100vh-4rem)] overflow-y-auto border-r border-[#d0d7de]">
          {/* Header */}
        ...
        <div className="hidden lg:block w-64 shrink-0 px-4 py-6 h-[calc(100vh-4rem)] overflow-y-auto">
