...
CREATE OR REPLACE FUNCTION "public"."update_user_menu_visits_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_user_menu_visits_updated_at"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."figma_comment_reads" (
...
ALTER TABLE "public"."figma_comment_reads" OWNER TO "postgres";


COMMENT ON TABLE "public"."figma_comment_reads" IS '사용자별 댓글 읽음 상태';
...
CREATE TABLE IF NOT EXISTS "public"."figma_comments" (
    ...
    "figma_created_at" timestamp with time zone NOT NULL,
    "received_at" timestamp with time zone DEFAULT "now"() NOT NULL
);


ALTER TABLE "public"."figma_comments" OWNER TO "postgres";


COMMENT ON TABLE "public"."figma_comments" IS 'Figma 댓글 캐시 (실시간 동기화)';



COMMENT ON COLUMN "public"."figma_comments"."parent_id" IS '대댓글인 경우 부모 댓글의 comment_id';



COMMENT ON COLUMN "public"."figma_comments"."figma_created_at" IS 'Figma에서의 원본 생성 시각';



CREATE TABLE IF NOT EXISTS "public"."figma_tracked_files" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "workspace_id" "uuid" NOT NULL,
    "file_key" "text" NOT NULL,
    ...
    "webhook_id" "text",
    "webhook_passcode" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "has_comment_access" boolean DEFAULT false NOT NULL
);


ALTER TABLE "public"."figma_tracked_files" OWNER TO "postgres";


COMMENT ON TABLE "public"."figma_tracked_files" IS 'Figma 파일 추적 목록';



COMMENT ON COLUMN "public"."figma_tracked_files"."thumbnail_url" IS 'Figma CDN에서 생성된 썸네일 이미지 URL';



COMMENT ON COLUMN "public"."figma_tracked_files"."webhook_id" IS 'Figma Webhook ID (댓글 이벤트 수신용)';



COMMENT ON COLUMN "public"."figma_tracked_files"."webhook_passcode" IS 'Webhook 요청 검증용 passcode';



COMMENT ON COLUMN "public"."figma_tracked_files"."has_comment_access" IS '댓글 읽기/쓰기 권한 여부 (view-only 파일은 false)';
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "figma_encrypted_tokens" "text",
    "figma_user_id" "text",
    "figma_connected_at" timestamp with time zone
);
...
COMMENT ON COLUMN "public"."profiles"."figma_encrypted_tokens" IS 'AES-256-GCM으로 암호화된 Figma OAuth 토큰 (access_token, refresh_token, expires_at)';



COMMENT ON COLUMN "public"."profiles"."figma_user_id" IS 'Figma User ID (OAuth에서 반환)';



COMMENT ON COLUMN "public"."profiles"."figma_connected_at" IS 'Figma 연동 시각';
...
CREATE TABLE IF NOT EXISTS "public"."user_menu_visits" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "workspace_id" "uuid" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "menu_key" "text" NOT NULL,
...
ALTER TABLE "public"."user_menu_visits" OWNER TO "postgres";


COMMENT ON TABLE "public"."user_menu_visits" IS '사용자별 메뉴 방문 기록 (새 데이터 알림용)';



COMMENT ON COLUMN "public"."user_menu_visits"."menu_key" IS '메뉴 키 (feedbacks, team-feed, plans, snapshots, alignment, work-map, collaborator-graph, my-dashboard, my-alignment, my-snapshots 등)';



COMMENT ON COLUMN "public"."user_menu_visits"."last_visited_at" IS '마지막 방문 시간';
...
ALTER TABLE ONLY "public"."figma_comment_reads"
    ADD CONSTRAINT "figma_comment_reads_pkey" PRIMARY KEY ("user_id", "comment_id");



ALTER TABLE ONLY "public"."figma_comments"
    ADD CONSTRAINT "figma_comments_comment_id_key" UNIQUE ("comment_id");



ALTER TABLE ONLY "public"."figma_comments"
    ADD CONSTRAINT "figma_comments_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."figma_tracked_files"
    ADD CONSTRAINT "figma_tracked_files_file_key_key" UNIQUE ("file_key");



ALTER TABLE ONLY "public"."figma_tracked_files"
    ADD CONSTRAINT "figma_tracked_files_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."user_menu_visits"
    ADD CONSTRAINT "user_menu_visits_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."user_menu_visits"
    ADD CONSTRAINT "user_menu_visits_unique" UNIQUE ("workspace_id", "user_id", "menu_key");
...
CREATE INDEX "idx_figma_comment_reads_comment" ON "public"."figma_comment_reads" USING "btree" ("comment_id");



CREATE INDEX "idx_figma_comment_reads_user" ON "public"."figma_comment_reads" USING "btree" ("user_id");



CREATE INDEX "idx_figma_comments_created_at" ON "public"."figma_comments" USING "btree" ("figma_created_at" DESC);



CREATE INDEX "idx_figma_comments_file_key" ON "public"."figma_comments" USING "btree" ("file_key");



CREATE INDEX "idx_figma_comments_parent_id" ON "public"."figma_comments" USING "btree" ("parent_id") WHERE ("parent_id" IS NOT NULL);



CREATE INDEX "idx_figma_tracked_files_file_key" ON "public"."figma_tracked_files" USING "btree" ("file_key");



CREATE INDEX "idx_figma_tracked_files_workspace" ON "public"."figma_tracked_files" USING "btree" ("workspace_id");
...
CREATE INDEX "idx_profiles_figma_user_id" ON "public"."profiles" USING "btree" ("figma_user_id");
...
CREATE INDEX "idx_user_menu_visits_menu" ON "public"."user_menu_visits" USING "btree" ("workspace_id", "menu_key");



CREATE INDEX "idx_user_menu_visits_user" ON "public"."user_menu_visits" USING "btree" ("workspace_id", "user_id");
...
CREATE OR REPLACE TRIGGER "user_menu_visits_updated_at" BEFORE UPDATE ON "public"."user_menu_visits" FOR EACH ROW EXECUTE FUNCTION "public"."update_user_menu_visits_updated_at"();
...
ALTER TABLE ONLY "public"."figma_comment_reads"
    ADD CONSTRAINT "figma_comment_reads_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("user_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."figma_tracked_files"
    ADD CONSTRAINT "figma_tracked_files_registered_by_fkey" FOREIGN KEY ("registered_by") REFERENCES "public"."profiles"("user_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."figma_tracked_files"
    ADD CONSTRAINT "figma_tracked_files_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."figma_comment_reads"
    ADD CONSTRAINT "fk_comment_id" FOREIGN KEY ("comment_id") REFERENCES "public"."figma_comments"("comment_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."figma_comments"
    ADD CONSTRAINT "fk_file_key" FOREIGN KEY ("file_key") REFERENCES "public"."figma_tracked_files"("file_key") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."plan_assignees"
    ADD CONSTRAINT "fk_plan_assignees_user_id" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("user_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."snapshots"
    ADD CONSTRAINT "fk_snapshots_author_id" FOREIGN KEY ("author_id") REFERENCES "public"."profiles"("user_id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."workspace_members"
    ADD CONSTRAINT "fk_workspace_members_user_id" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("user_id") ON DELETE CASCADE;
...
CREATE POLICY "Users can insert own menu visits" ON "public"."user_menu_visits" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can update own menu visits" ON "public"."user_menu_visits" FOR UPDATE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view own menu visits" ON "public"."user_menu_visits" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
ALTER TABLE "public"."user_menu_visits" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."update_user_menu_visits_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_user_menu_visits_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_user_menu_visits_updated_at"() TO "service_role";
...
GRANT ALL ON TABLE "public"."figma_comment_reads" TO "anon";
GRANT ALL ON TABLE "public"."figma_comment_reads" TO "authenticated";
GRANT ALL ON TABLE "public"."figma_comment_reads" TO "service_role";



GRANT ALL ON TABLE "public"."figma_comments" TO "anon";
GRANT ALL ON TABLE "public"."figma_comments" TO "authenticated";
GRANT ALL ON TABLE "public"."figma_comments" TO "service_role";



GRANT ALL ON TABLE "public"."figma_tracked_files" TO "anon";
GRANT ALL ON TABLE "public"."figma_tracked_files" TO "authenticated";
GRANT ALL ON TABLE "public"."figma_tracked_files" TO "service_role";
...
GRANT ALL ON TABLE "public"."user_menu_visits" TO "anon";
GRANT ALL ON TABLE "public"."user_menu_visits" TO "authenticated";
GRANT ALL ON TABLE "public"."user_menu_visits" TO "service_role";
