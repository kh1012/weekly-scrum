...
- **Work Map**: 프로젝트/사람 기준 계층 구조 탐색, 협업 네트워크 시각화
- **스냅샷 뷰어**: 전체/사람별/연속성 분석 뷰, 카드/리스트 보기 토글
- **GNB 다중 필터**: 담당자/도메인/프로젝트/모듈/피쳐 필터링, 상태 저장
- **릴리즈 노트**: 버전별 변경 사항 확인
- **페이지 상태 복원**: 마지막 방문 페이지 자동 이동
...
| 페이지                      | 경로         | 설명                                           |
| --------------------------- | ------------ | ---------------------------------------------- |
| **Work Map**                | `/work-map`  | 프로젝트/사람 기준 계층 탐색 및 협업 네트워크  |
| **스냅샷 뷰어**             | `/snapshots` | 스냅샷 전체/사람별/연속성 분석 뷰              |
